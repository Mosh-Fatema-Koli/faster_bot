...
//       log.i("onMessageOpenedApp Message : $message");
//     });
//
...
//             log.i("Initialize Local Notification payload : $_payloadData");
//
...
//       'notification_id', // meta-data android value
...
//     if (data["type"] == "NEW_NOTICE_ADDED") {
//       debugPrint("Notification Action : >> ${data['notice_id']} ${data['alert_id']}");
//    //   Get.to(NoticeDetailsScreen(id:int.parse(data['notice_id']), alertId:int.parse(data['alert_id']),));
